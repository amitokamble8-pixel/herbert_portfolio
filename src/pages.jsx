...
const ConnectPanel = () => (
  <Reveal>
    <div className="connect">
      ...
      <p>
     For research collaborations, engineering projects, internships, or robotics initiatives — or simply to discuss aerospace, computational problem-solving, or technology — I'd love to connect.
      </p>
      <div className="cta-row">
...
export function Home() {
  usePageMeta(
    `${SITE} | Aerospace Engineering & Robotics Researcher`,
    "I am a Grade 12 IB student at the American International School of Accra with a strong interest in aerospace engineering, physics, robotics, and computational problem-solving."
  );
  return (
    <>
      <Hero />
      ...
      <section className="section">
        <SectionHead title="Awards & Recognitions" eyebrow="Debate · Competition · Academic" />
      ...
      <section className="section">
        <SectionHead title="Research & Experience" eyebrow="BEYOND THE CLASSROOM" />
      ...
      <section className="section">
        <SectionHead title="Teaching & Community" eyebrow="LEADING THROUGH SERVICE" />
        <Reveal>
...
export function About() {
  ...
  return (
    <section className="section">
      <PageHead title="About" eyebrow="American International School of Accra" />
      ...
      <SubHead title="Education" eyebrow="Accra, Ghana" />
      <div className="stack">
        {EDUCATION.map((e, i) => (
...
export function Work() {
  ...
  return (
    <section className="section">
      <PageHead title="Research & Experience" eyebrow="BEYOND THE CLASSROOM" />
      <div className="grid-2">
        {EXPERIENCE.map((e, i) => (
...
export function Projects() {
  usePageMeta(`Featured Projects | ${SITE}`, "Research and software projects, from wearable diagnostics to mobile applications.");
  return (
    <section className="section">
...
export function Awards() {
  ...
  return (
    <section className="section">
      <PageHead title="Awards & Recognitions" eyebrow="Debate · Competition · Academic" />
      <div className="row-list">
        {AWARDS.map((a, i) => (
...
export function Volunteering() {
  usePageMeta(`Teaching & Community | ${SITE}`, "Founding a machine learning club, teaching summer band, and community volunteering.");
  return (
    <section className="section">
      <PageHead title="Teaching & Community" eyebrow="LEADING THROUGH SERVICE" />
      <Reveal>
        <div className="vol-panel">
          <div className="vol-stats">
            {VOLUNTEER.stats.map((s) => (
